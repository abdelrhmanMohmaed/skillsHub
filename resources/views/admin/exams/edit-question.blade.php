                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a
                                    href="{{ url("/dashboard/exams/show/$exam->id") }}">{{ $exam->name('en') }}</a>
                            </li>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 pb-3">
                        ...
                        <form method="POST"
                            action="{{ url("dashboard/exams/update-questions/{$exam->id}/{$ques->id}") }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="1" max="4" class="form-control" name="right_ans"
