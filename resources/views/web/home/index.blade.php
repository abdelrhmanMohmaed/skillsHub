...
@section('main')
    ...
    <div id="home" class="hero-area">
        ...
        <div class="bg-image bg-parallax overlay"
            style="background-image:url({{ asset('web/img/home-background.jpg') }})">
        </div>
        <!-- /Backgound Image -->
                    ...
                    <div class="col-md-8">
                        ...
                        @auth
                            <a class="main-button icon-button"
                                href="{{ url('categories/show/1') }}">@lang('web.getStartedBtn')</a>
                        @endauth
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="center-btn">
                    <a class="main-button icon-button"
                        href="{{ url('/categories/show/1') }}">@lang('web.moreExamBtn')</a>
                </div>
            </div>
